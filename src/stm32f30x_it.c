...
extern __IO int time_us;
extern __IO int time_ms;
...
void TIM3_IRQHandler(void)
{
	...
	{
		TIM3 -> SR &= ~TIM_IT_CC4;	// Clear capture compare flag by software;
		STM_EVAL_LEDToggle(LED6);	// LED6 toggling with frequency = 1 Hz.
	}
